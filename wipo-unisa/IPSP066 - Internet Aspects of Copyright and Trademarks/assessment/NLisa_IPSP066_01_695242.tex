...
trade mark infringement,\footnote{Restricted to goods and services which are the same or similar to those for which the mark is registered.\label{org9eba6d6}} in that it extends to use of the offending mark to
...
the Republic view this in the `traditional' trade mark infringement\textsuperscript{\ref{org9eba6d6}}
