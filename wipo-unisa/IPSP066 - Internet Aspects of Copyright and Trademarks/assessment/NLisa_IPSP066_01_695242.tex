...
trade mark infringement,\footnote{Restricted to goods and services which are the same or similar to those for which the mark is registered.\label{orgdcfb91e}} in that it extends to use of the offending mark to
...
the Republic view this in the `traditional' trade mark infringement\textsuperscript{\ref{orgdcfb91e}}
